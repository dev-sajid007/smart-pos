        ...
        <div class="tile mb-4">
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-header">
                        <h2 class="mb-3 line-head" id="navs">Sms Api Create
            ...
            <div class="row" style="margin-bottom: 2rem;">
                <div class="col-12">
                    ...
                    <form method="post" action="{{ route('sms-apis.store') }}">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-10 offset-md-1">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" value="{{ old('api_title') }}" name="api_title" class="form-control" placeholder="Actual name of api url">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="form-control" cols="5" style="height: 130px" placeholder="mobile_number_field=DYNAMIC_MOBILE_NUMBERS&message_field=DYNAMIC_MESSAGE" name="api_url">{{ old('api_url') }}</textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="form-control" cols="3" style="min-height: 70px" placeholder="full sms balance url" name="get_sms_balance_rul">{{ old('get_sms_balance_rul') }}</textarea>
