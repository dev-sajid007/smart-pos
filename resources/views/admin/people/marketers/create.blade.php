        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="tile">
                    ...
                    <div class="tile-body">
                        <hr>
                        <form class="form-horizontal pl-5" method="POST" enctype="multipart/form-data" action="{{ route('marketers.store') }}">
                            @csrf
                            <!-- Name -->
                            <div class="form-group row add_asterisk">
                                <label class="control-label col-md-2">Name</label>
                                <div class="col-md-6">
                                    <input name="marketers_name" value="{{ old('marketers_name') }}" class="form-control" type="text" placeholder="Name">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input name="marketers_mobile" value="{{ old('marketers_mobile') }}" class="form-control" type="text"
                                ...
                                <div class="col-md-8">
                                    <table  class="table table-sm table-bordered" id="table" width="100%">
                                        ...
                                        <tbody class="item-table-body">
                                            <tr>
                                                <td>
                                                    <input name="start_amount[]" value="{{ old('start_amount')??0 }}" class="form-control"
                                                ...
                                                <td>
                                                    <input name="end_amount[]" value="{{ old('end_amount')??0 }}" class="form-control"
                                                           type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                                ...
                                                <td>
                                                    <input name="marketers_commission[]" value="{{ old('marketers_commission')??0 }}" class="form-control" type="number"
                            ...
                            <div class="tile-footer">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        fa-lg fa-check-circle"></i>Add marketer
                                        </button>
                                    </div>
                                </div>
                            </div>
...
@section('js')
    ...
    <script type="text/javascript"
        src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-sweetalert/1.0.1/sweetalert.js">
    </script>
