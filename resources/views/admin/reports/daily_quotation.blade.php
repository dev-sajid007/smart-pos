...
<script src="{{ asset('assets/admin/js/main.js') }}"></script>
  ...
  <script type="text/javascript" src="{{ asset('assets/admin/js/plugins/jquery-ui.custom.min.js') }}"></script>
  <script type="text/javascript" src="{{ asset('assets/admin/js/plugins/fullcalendar.min.js') }}"></script>
