...
@section('title', ' - Supplier Wise Sale Report')
@push('style')
    <style type="text/css">
        @media print {
            .d-none {
                                    ...
                                    <tbody>
                                        @isset($sales)
                                            ...
                                            @foreach($sales as $sales_info)
                                                @foreach($sales_info->sale_details as $key => $salesProduct)
                                                    <tr>
                                                        <td>{{ $key + 1 }}</td>
                                                        ...
                                                        <td class="text-right">{{ number_format(($salesProduct->quantity * $salesProduct->unit_price), 2) }}</td>
                                                    </tr>
                                                    @php
