...
@section('content')
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-edit"></i> Warehouse</h1>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    ...
                    <h3 class="tile-title">Add New Warehouses</h3>
                    ...
                    <div class="tile-body" style="min-height: 740px !important;">
                        <form class="form-horizontal" method="post" action="{{ route('warehouses.store') }}">
                            ...
                            <div class="form-group row add_asterisk">
                                ...
                                <div class="col-md-8">
                                    <input name="name" class="form-control" type="text" placeholder="Warehouse Name">
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <button class="btn btn-primary pull-right" type="submit">
                                            <i class="fa fa-fw fa-lg fa-check-circle"></i> Save Warehouse
                                        </button>
                                    </div>
                                </div>
                            </div>
