...
@section('content')
    ...
    <main class="app-content">
        <form class="form-horizontal" method="POST" action="{{ route('product-packages.store') }}">
            @csrf
            <div class="row">
                <div class="col-sm-10 mx-auto">
                    <div class="card">
                        <div class="card-header bg-primary text-white">
                            <i class="fa fa-plus"></i> Create Product Package
                            ...
                            <div class="row">
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" style="height: 36px" name="name" value="{{ old('name') }}" >
                                    </div>
                                </div>

                                <div class="col-sm-2 text-right">
                                    <button class="btn btn-primary" type="submit"><i class="fa fa-save"></i> Save Package</button>
                                </div>
                            </div>
