...
<main class="app-content">
        ...
        <div class="row">
                <div class="col-md-12">
                        <div class="tile">
                          <a href="{{route('discounts.index')}}" class="btn btn-primary pull-right" style="float: right;"><i class="fa fa-eye"></i>View Discount</a>
                          <h3 class="tile-title">Add New Discount</h3>
                          <div class="tile-body">
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <button class="btn btn-primary pull-right" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Add Discount</button>
                              </div>
                            </div>
                          </div>
                            </form>
