        ...
        <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="tile">
                          ...
                          <h3 class="tile-title">Add New Package</h3>
                          <div class="tile-body">
                            <form class="form-horizontal" method="POST" action="{{ route('packages.store') }}">
                                  ...
                                  <div class="col-md-8">
                                    <select name="fk_billing_cycle_id" id="" class="form-control select2">
                                      @foreach ($billing_cycles as $id => $billing_cycle)
                                          <option value="{{ $id }}">{{ $billing_cycle }}</option>
                                      @endforeach
                                    </select>
                                  </div>
                              </div>
                              ...
                              <div class="form-group row add_asterisk">
                                ...
                                <div class="col-md-8">
                                  <input type="number" min="1" class="form-control" name="trial_period" placeholder="Trial Period" value="{{ old('trial_period') }}">
                                  <div class="text-danger">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="number" name="alert_before" id="" class="form-control" placeholder="Alert Before(Days)" value="{{ old('alert_before') }}">
                                    <div class="text-danger">
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                    <textarea name="description" class="form-control" rows="5" type="text" placeholder="Description">{{ old('description') }}</textarea>
                                    <div class="text-danger">
                              ...
                              <div class="tile-footer">
                                <div class="row">
                                  <div class="col-md-12">
                                    <button class="btn btn-primary pull-right" type="submit" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Add Package</button>
                                  </div>
                                </div>
                              </div>
                            </form>
