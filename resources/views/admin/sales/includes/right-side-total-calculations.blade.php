            ...
            <div class="card-body" style="padding-top: 8px !important;">
                ...
                @if($settings->where('title', 'Courier Service For Sale')->where('options', 'yes')->count() > 0)
                    <div class="input-group currier-amount mb-1">
                        ...
                        <input type="text" name="currier_amount" value="{{ old('currier_amount') }}" class="form-control input-currier-amount height-30" autocomplete="off" placeholder="Currier Service Amount" onkeyup="calculateTotal()"  onkeypress="return IsNumeric(event);">
                    </div>
                @else
                ...
                <div class="input-group mb-1">
                    ...
                    <input type="text" name="discount_percent" value="{{ old('discount_percent') }}" class="form-control text-center discount-percent height-30" placeholder="%"  onkeypress="return IsNumeric(event);">
                    <input type="text" name="invoice_discount" value="{{ old('invoice_discount') }}" class="form-control text-center discount-amount height-30" placeholder="Amount" onkeypress="return IsNumeric(event);">
                </div>
                ...
                <div class="input-group mb-1">
                    ...
                    <input type="text" name="cod_percent" value="{{ old('cod_percent') }}" class="form-control text-center cod-percent height-30" onkeyup="calculateCODAmount(this)" placeholder="%" onkeypress="return IsNumeric(event);">
                    <input type="text" name="cod_amount" value="{{ old('cod_amount') }}" readonly class="form-control text-center cod-amount height-30" placeholder="Amount">
                </div>
                ...
                <div class="input-group mb-1">
                    ...
                    <input type="text" name="previous_due" value="{{ old('previous_due', optional($customers->where('is_default', 1)->first())->balance) }}" readonly class="form-control previous-due height-30">
                </div>
                ...
                <div class="input-group mb-1">
                    ...
                    <input type="text" name="advanced_payment" value="{{ old('advanced_payment') }}" readonly class="form-control advanced-payment height-30">
                </div>
                ...
                <div class="input-group mb-1">
                    ...
                    <input type="text" name="receive_amount" value="{{ old('receive_amount') }}" class="form-control receive-amount height-30" autocomplete="off"  onkeypress="return IsNumeric(event);">
                </div>
                 <!-- Receive Amount -->
                 <div class="input-group mb-1">
                    <div class="input-group-prepend">
                        <label class="font-weight-bold input-group-text">COD amount</label>
                    </div>
                    <input type="checkbox" id="exclude_cod" class="form-control" style="height: 20px !important">
                </div>
