    ...
    <main class="app-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form class="form-horizontal" action="{{ route('asset-purchases.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf

                    <div class="tile">
                        <h3 class="tile-title">Asset Purchase</h3>
                        <div class="tile-body" style="height: 740px !important;">

                            <table class="table table-sm" style="border: none">
                                <tr style="border: none">
                                    <td style="width: 20px; border:none">Asset</td>
                                    <td style="border: none">
                                        <select class="form-control select-asset select2">
                                    ...
                                    <td style="border: none">
                                        <button type="button" class="add-item form-control btn btn-dark" onclick="addAsset()"><i class="fa fa-plus"></i> Add</button>
                                    </td>
                                </tr>
...
@section('js')
    <script >
        ...
        function addAsset()
        {
            let asset_id    = $('.select-asset option:selected').val()
            let asset_name  = $('.select-asset option:selected').text()
