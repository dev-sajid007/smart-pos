...
<main class="app-content">
        <div class="app-title">
          <div>
            <h1><i class="fa fa-edit"></i> Manage Company Billing</h1>
            <p>Manage Company Billing Form</p>
          </div>
          <ul class="app-breadcrumb breadcrumb">
            <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
            <li class="breadcrumb-item">Companies</li>
            <li class="breadcrumb-item"><a href="#">Manage Company Billing</a></li>
          </ul>
        </div>
        <div class="row">
                <div class="col-md-12">
                  ...
                  @endif
                  <div class="tile">
                    <a href="{{route('company_packages.create')}}" class="btn btn-primary" style="float: right;"><i class="fa fa-plus"></i>Add Company Billing</a>
                    <h3 class="tile-title">Company Billing List </h3>
                      ...
                      <table class="table table-hover table-bordered" id="">
                        ...
                        <tbody>
                          ...
                          <tr>
                              ...
                              <td>{{ $company_package->package->billing_cycle->name }}</td>
