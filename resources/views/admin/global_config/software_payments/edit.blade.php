            ...
            <div class="app-title">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form class="form-horizontal" action="{{ route('software_payments.update',$softwarePayment->id) }}" enctype="multipart/form-data" method="POST">
                            @csrf @method('put')
                            <div class="tile">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="software_payment_date" class="form-control dateField" value="{{ old('end_date') ?: $softwarePayment->software_payment_date }}" min="1">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="number" name="amount" class="form-control" value="{{ old('amount') ?: $softwarePayment->amount }}" min="1">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="number" name="alert" class="form-control" value="{{ old('alert') ?: $softwarePayment->alert }}" min="1">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <option value="1" {{ $softwarePayment->status == 1 ? 'selected':'' }}>Approved</option>
                                        <option value="0" {{ $softwarePayment->status == 0 ? 'selected':'' }}>Pending</option>
                                        </select>
                            ...
                            <div class="tile-footer">
                                <div class="row">
                                <div class="col-md-12">
                                    <button class="btn btn-primary pull-right" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Submit</button>
                                </div>
                                </div>
                            </div>
                            </div>
